  ...
  import {getFirestore, collection, addDoc, getDocs, onSnapshot, deleteDoc, doc, getDoc, updateDoc, query, where , orderBy, startAt} from "https://www.gstatic.com/firebasejs/9.6.4/firebase-firestore.js";
...
/* export const myQuery = query(libretasRef,where("LibIdentificador", "==", "123354"));
export const docRef = doc(db, "Libretas", "LibIdentificador");
